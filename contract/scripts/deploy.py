...
def main():
    ...
    price_A_before, price_B_before = amm.getMarginalPrices(market_total_A_before, market_total_B_before)
    ...
    # 测试价格变化
    price_A_final, price_B_final = amm.getMarginalPrices(market_total_A_after, market_total_B_after)
