  ...
  return (
    <Menubar className="mb-4 space-x-4">
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarItem onSelect={() => setCategory("Currency")}>
            Currency
          </MenubarItem>
          <MenubarItem onSelect={() => setCategory("General")}>
            General
          </MenubarItem>
        </MenubarContent>
      </MenubarMenu>
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarItem onSelect={() => setIsCurrencyDialogOpen(true)}>
            Currency
          </MenubarItem>
          <MenubarItem onSelect={() => setIsGeneralDialogOpen(true)}>
            General
          </MenubarItem>
        </MenubarContent>
      </MenubarMenu>
